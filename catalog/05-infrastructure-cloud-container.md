...
A consolidated `security-engineer` persona plus cloud-posture, WAF, K8s, and
Terraform specialist skills for the depth a single agent can only summarize. Picks
and licenses in [curated/](../curated/#5-infrastructure--cloud--container-security).
